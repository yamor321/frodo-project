...
def render_methodology_html() -> str:
  ...
  <div class="method-section">
    <h2>3. מדד חיסכון לסניף (המפה, דירוג הסניפים, דף סניף)</h2>
    <p>לכל מוצר משותף בין 4 סניפים לפחות, כל סניף מקבל אחוזון לפי מיקומו במחיר. ציון הסניף הוא הממוצע של האחוזונים האלה על כל המוצרים המשותפים שהוא מוכר, ואז הופך למדד חיסכון שמוצג באתר (100=עקבית הכי זול, 0=עקבית הכי יקר) — כדי שמספר גבוה יקרא כ"טוב", כמו בכל "ציון מתוך 100" רגיל. זה מספר יחסי בין הסניפים שנאספו באתר בלבד — לא "יקר" או "זול" באופן מוחלט.</p>
  </div>
  ...
  <div class="method-section">
    <h2>7. מגמת מחיר לאורך זמן והמדד העצמי</h2>
    <p>לכל מוצר, האתר שומר יום-יום (ולא דורס) את המחיר הזול/ממוצע/יקר שנמצא בכל הסניפים שמוכרים אותו, החל מ-26.08.2026 — אין דרך להשיג היסטוריה אמיתית מלפני כן, כי אף אחד מהפורטלים הרשמיים לא חושף ארכיון (רק הקובץ הכי עדכני נגיש, נבדק ישירות). לצד זה, מוצג "מדד המחירים העצמי" של הפרויקט: לכל יום, לוקחים את היחס בין המחיר הממוצע של אותו יום למחיר הממוצע ביום הראשון שבו כל מוצר נאסף, ומחשבים את החציון של כל היחסים האלה על פני כל המוצרים — אותו רעיון בדיוק כמו מדד מחירים לצרכן (שינוי יחסי בסל מוצרים לאורך זמן), אבל משוחזר לגמרי מהקבצים הרשמיים שהפרויקט הזה כבר אוסף, לא מיובא ממקור חיצוני.</p>
    <div class="principle">עיקרון: שני הגרפים מתחילים יחד ב-26.08.2026 וגדלים יום אחרי יום. אין "עומק של שנים בחינם" — לא נבחר מדד חיצוני (כמו מדד המחירים לצרכן של הלמ"ס) כי הוא לא משוחזר מהנתונים של הפרויקט עצמו.</div>
  </div>
