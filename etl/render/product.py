...
.prow .price{ font-weight:700; font-size:1.15rem; font-variant-numeric:tabular-nums; }
...
.chart-headline{ margin:0 0 6px; direction:ltr; font-size:1.1rem; font-weight:700; }
